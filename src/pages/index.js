    ...
    <>
      <div className="container logo centered">
        <div style={
          ...
          <img src="/img/jscc-logo-2019.png" alt="logo" height={560} width={486}/>

          {(pub._data.colorVoting.active) && <div>*</div>}
        </div>
      </div>

      { /*
     (pub._data.colorVoting.active) && (
    <style type="text/css">
      .vote a {
    ...
    */
      ...
      <div className="container">
        <div className="row">
          <div className="col s12 m12">
            {pub._data.colorVoting.active &&
            <div className="vote center">* <a href={pub._data.colorVoting.url}>Please vote for this year's color!</a>
            </div>
            }
            <h1 className="header center <%= pub._data.baseColor %>-text">JSCraftCamp 2019</h1>
            <h3 className="header center">Will return to Munich, July 19th - 20th 2019!</h3>
            <h3 className="header center light">A BarCamp about JavaScript and Crafting Software</h3>
            <h3 className="header center light"><a href="/photos2018">Impressions from 2018</a></h3>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col s12 m4 offset-m4">
            <h4 className="header center <%= pub._data.baseColor %>-text">
      ...
      <div className="container">
          ...
          <div className="col s12 m6">
            ...
            <p className="block">Attendance is <strong>free of charge</strong> and we encourage to sign up in advance.
              ...
              <a href="http://stackoverflow.com/questions/14680711/how-to-do-a-github-pull-request" target="_blank">Pull
                Request</a>.
              More infos and explanations can be found on the <Link to="registration.html">Registration Page.</Link>
            </p>
          </div>
        </div>

        <div className="row">
          <h4 className="header center <%= pub._data.baseColor %>-text">Facilitation by</h4>
          <h5 className="header center">Cecilia Maria Zannini - <a href="https://connexxo.com">Connexxo</a></h5>
        </div>

        <a name="schedule"/>
        <h4 className="header center <%= pub._data.baseColor %>-text">Schedule</h4>
        <div className="row">
          <div className="col s12 m12">
            <div className="col s12 m6">
          ...
          <div className="col s12 m12">
            <h5 className="header center <%= pub._data.baseColor %>-text">Take notes!</h5>
            <p>
              ...
              <a href="https://github.com/jscraftcamp/jscc19-sessions">official repository for session notes</a>!
            </p>
          </div>
        </div>

        <div className="row" id="sponsors">
          <h4 className="header center <%= pub._data.baseColor %>-text">Sponsors</h4>
        ...
        */
        ...
        <a name="location"/>
        <h4 className={`header center ${pub._data.baseColor}-text`}>Location</h4>
